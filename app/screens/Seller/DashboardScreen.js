    ...
    try {
      ...
      const fetchStats = async () => {
        try {
          ...
          const { data: statsData, error: statsError } = await supabase
            .from('seller_stats')
            .select('total_revenue, total_orders, completed_orders, total_products')
            .in('shop_id', shopIds);
          ...
          }, { totalRevenue: 0, totalOrders: 0, pendingOrders: 0, totalProducts: 0 });
          ...
          console.error('Error fetching stats from seller_stats:', error.message);
      ...
      const calculateStatsManually = async () => {
        try {
          ...
          console.log('Aggregated stats across all shops - products:', totalProducts, 'orders:', totalOrders);
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statsRow}>
            <View style={styles.statCard}>
              <View style={[styles.statIconContainer, { backgroundColor: 'rgba(65, 105, 225, 0.1)' }]}>
              ...
              {lowStockProducts.map((product) => (
                ...
                >
                  ...
                  <View style={styles.stockInfo}>
                    ...
                    <Text style={[
                      styles.stockValue, 
                      product.stock_quantity <= 0 ? styles.outOfStock : styles.lowStock
                    ]}>
