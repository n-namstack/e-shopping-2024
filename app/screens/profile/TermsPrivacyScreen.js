...
const TermsPrivacyScreen = () => {
  ...
  const renderTermsContent = () => (
    <View style={styles.content}>
      ...
      <Text style={styles.paragraph}>
        To use certain features of the application, you must register for an account. You agree to provide accurate information and keep your account information updated.
      </Text>
      ...
      <Text style={styles.listItem}>• Post unauthorized commercial communications</Text>
      <Text style={styles.listItem}>• Upload viruses or malicious code</Text>
      <Text style={styles.listItem}>• Collect users' information without their consent</Text>
      <Text style={styles.listItem}>• Engage in unlawful multi-level marketing</Text>

      <Text style={styles.sectionTitle}>4. Seller Terms</Text>
      <Text style={styles.paragraph}>
        Sellers must comply with all applicable laws and regulations. Products must be accurately described and priced. Sellers are responsible for shipping and customer service.
      </Text>

      <Text style={styles.sectionTitle}>5. Buyer Terms</Text>
      <Text style={styles.paragraph}>
        Buyers agree to pay for items purchased and provide accurate shipping information. Buyers must comply with return policies as specified by sellers.
      </Text>

      <Text style={styles.sectionTitle}>6. Intellectual Property</Text>
      <Text style={styles.paragraph}>
        The application and its original content are protected by copyright, trademark, and other laws. Our trademarks may not be used without our prior written permission.
      </Text>
      ...
      <Text style={styles.paragraph}>
        We reserve the right to modify or replace these terms at any time. We will provide notice of any changes by posting the new terms on the application.
      </Text>
    </View>
  );
  ...
  const renderPrivacyContent = () => (
    <View style={styles.content}>
      ...
      <Text style={styles.paragraph}>
        We use cookies and similar technologies to collect information about your browsing activities and to manage your preferences.
      </Text>
