...
const CheckoutScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    cartItems.forEach((item) => {
      ...
      if (item.in_stock) {
        ...
        switch (deliveryLocation) {
          case "local":
            if (
              item.delivery_fee_local !== null &&
              item.delivery_fee_local !== undefined
            ) {
          ...
          case "uptown":
            if (
              item.delivery_fee_uptown !== null &&
              item.delivery_fee_uptown !== undefined
            ) {
          ...
          case "outoftown":
            if (
              item.delivery_fee_outoftown !== null &&
              item.delivery_fee_outoftown !== undefined
            ) {
          ...
          case "countrywide":
            if (
              item.delivery_fee_countrywide !== null &&
              item.delivery_fee_countrywide !== undefined
            ) {
        ...
        if (
          item.free_delivery_threshold > 0 &&
          itemTotal >= item.free_delivery_threshold
        ) {
    ...
    const calculatedTotal =
      standardSum + onOrderSum + shippingFee + deliveryFees + runnerFees;
  ...
  const handleNextStep = () => {
    if (step === 1) {
      ...
      if (!paymentTiming) {
        Alert.alert(
          "Missing Information",
          "Please choose when you want to pay.",
        );
        return;
      }
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const finalPaymentMethod =
        paymentTiming === PaymentTiming.LATER ? "pay_later" : paymentMethod;
      const finalPaymentProof =
        paymentTiming === PaymentTiming.LATER ? null : paymentProofImage?.uri;
      ...
      if (finalPaymentMethod === PaymentMethod.CARD) {
        try {
          const { paymentUrl, transToken } = await createDPOToken(
            firstOrder.id,
            result.totalAmount,
          );
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        ...
        <View style={styles.paymentTimingOptions}>
          ...
          >
            ...
            <View style={styles.paymentTimingDetails}>
              ...
              >
                Complete payment immediately and we'll process your order right
                away.
              </Text>
        ...
        {paymentTiming === PaymentTiming.LATER && (
          ...
          >
            ...
            >
              With "Pay Later", your order will be held until payment is
              completed. You can pay via cash on delivery or any digital payment
              method when ready.
            </Text>
          </View>
        )}
      ...
      return (
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.payLaterSelectedContainer}>
            ...
            <Text
              style={[styles.payLaterSelectedTitle, { color: colors.text }]}
            >
              Payment Deferred
            </Text>
            <Text
              style={[
                styles.payLaterSelectedDesc,
                {
                  color: isDarkMode ? "#aaa" : "#666",
                  fontFamily: FONTS.regular,
                },
            ...
            >
              You've chosen to pay later. Your order will be processed and you
              can pay when it's ready for delivery using any of the following
              methods:
            </Text>

            <View style={styles.futurePaymentMethods}>
              <Text style={[styles.futurePaymentTitle, { color: colors.text }]}>
                Available Payment Methods on Delivery:
              </Text>
              <View style={styles.futurePaymentList}>
                <Text
                  style={[
                    styles.futurePaymentItem,
                    {
                      color: isDarkMode ? "#aaa" : "#666",
                      fontFamily: FONTS.regular,
                    },
            ...
            >
              ...
              >
                We'll notify you when your order is ready for delivery and
                payment.
              </Text>
            </View>
          </View>
    ...
    return (
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        ...
        >
          ...
          {hasOnOrderItems &&
            " For on-order items, only a 50% deposit is charged today."}
        </Text>
        ...
        {paymentMethod &&
          ...
          paymentMethod !== PaymentMethod.CARD && (
            ...
            >
              <Text style={[styles.paymentProofTitle, { color: colors.text }]}>
                Payment Proof Required
              </Text>
              <Text
                style={[
                  styles.paymentProofDesc,
                  {
                    color: isDarkMode ? "#aaa" : "#666",
                    fontFamily: FONTS.regular,
                  },
        ...
        {hasOnOrderItems && (
          <View
            style={[
              styles.depositOptionsContainer,
              {
                backgroundColor: isDarkMode ? "#2a2a2a" : "#f9f9f9",
                borderColor: colors.border,
              },
          ...
          >
            <Text
              style={[
                styles.depositOptionsTitle,
                { color: colors.text, fontFamily: FONTS.semiBold },
              ]}
            >
              Payment Option for On-Order Items:
            </Text>
            ...
            >
              ...
              <View style={styles.depositOptionDetails}>
                ...
                >
                  Pay 50% now and the rest on delivery
                </Text>
              </View>
            </TouchableOpacity>
          </View>
        ...
        >
          ...
          {hasOnOrderItems && (
            ...
            >
              ...
              >
                {isDepositPayment
                  ? "You're paying a 50% deposit for on-order items. The remaining balance of N$" +
                    formatPrice(fullOnOrderTotal - onOrderTotal) +
                    " will be due when these items arrive."
